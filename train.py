...
@author: luokai
"""
# 注意torch版本为1.7，torchvision的版本0.5.0
import torch
...
# 如果用的gpu: device='cuda:0' cpu:device='cpu'同时把epochs=1, batchSize=2改小
# 下载.json等文件时候注意格式不能错，右键点复制链接地址可能下载的html文件，要特别注意会报错
...
if __name__ == '__main__':
    ...
    train(batchSize=2, device='cpu', lr=0.0001, use_dtp=True, pretrained_model=pretrained_model, tokenizer_model=tokenizer_model, weighted_loss=True)